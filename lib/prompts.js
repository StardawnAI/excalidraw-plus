  ...
  if (chartType && chartType !== 'auto') {
    ...
    if (chartTypeName) {
      ...
      if (visualSpec) {
        ...
        promptParts.push(
          `Please strictly follow the above visual specifications to design the diagram, ensuring:\n` +
          `- Use the shape types and colors specified in the specifications\n` +
          `- Follow the layout requirements in the specifications\n` +
          `- Apply the style attributes specified in the specifications (strokeWidth, fontSize, etc.)\n` +
    ...
    promptParts.push(
      'Based on user requirements, intelligently select the most appropriate chart type(s) to present information. Draw Excalidraw diagrams.\n\n' +
      '## Available Chart Types\n' +
      '- **Flowchart (flowchart)**: Suitable for showing processes, steps, decision logic\n' +
      '- **Mind Map (mindmap)**: Suitable for showing concept relationships, knowledge structure, brainstorming\n' +
      '- **Organization Chart (orgchart)**: Suitable for showing organizational structure, hierarchical relationships\n' +
      '- **Sequence Diagram (sequence)**: Suitable for showing system interactions, message passing, time sequence\n' +
      '- **UML Class Diagram (class)**: Suitable for showing class structure, inheritance relationships, object-oriented design\n' +
      ...
      '- **Tree Diagram (tree)**: Suitable for showing hierarchical structure, classification relationships\n' +
      '- **Network Topology (network)**: Suitable for showing network structure, node connections\n' +
      '- **Architecture Diagram (architecture)**: Suitable for showing system architecture, technology stack, layered design\n' +
      '- **Data Flow Diagram (dataflow)**: Suitable for showing data flow, processing\n' +
      '- **State Diagram (state)**: Suitable for showing state transitions, lifecycle\n' +
      '- **Swimlane Diagram (swimlane)**: Suitable for showing cross-department processes, responsibility division\n' +
      '- **Concept Map (concept)**: Suitable for showing concept relationships, knowledge graphs\n' +
      '- **Fishbone Diagram (fishbone)**: Suitable for showing cause-effect analysis, problem root causes\n' +
      '- **SWOT Analysis (swot)**: Suitable for showing strengths/weaknesses analysis, strategic planning\n' +
      '- **Pyramid Diagram (pyramid)**: Suitable for showing hierarchical structure, priorities\n' +
      '- **Funnel Diagram (funnel)**: Suitable for showing conversion processes, filtering\n' +
      '- **Venn Diagram (venn)**: Suitable for showing set relationships, intersections and unions\n' +
      '- **Matrix Diagram (matrix)**: Suitable for showing multi-dimensional comparisons, relationship matrices\n' +
      '- **Infographic (infographic)**: Suitable for showing data visualization, information display, creative charts\n' +
      '## Selection Guidelines\n' +
      '1. Analyze the core content and objectives of user requirements\n' +
      '2. Select the chart type(s) that most clearly express the information (can be one or multiple combined)\n' +
