      ...
      try {
        ...
        if (result.success) {
          setNotification({
            ...
            message: `Successfully imported ${result.count} configuration(s)`,
            type: 'success'
          });
          loadConfigs();
        } else {
      ...
      <div className="relative bg-white rounded border border-gray-300 w-full max-w-4xl mx-4 max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto px-6 py-4">
          ...
          <div className="mb-4 px-4 py-3 bg-blue-50 border border-blue-200 rounded">
            <p className="text-sm text-blue-800">Note: If access password is enabled, server-side configuration will be used and this configuration will be ignored</p>
          </div>
          ...
          <div className="space-y-3">
            {filteredConfigs.length === 0 ? (
              <div className="text-center py-8 text-gray-500">
                {searchQuery ? 'No matching configurations found' : 'No configurations yet. Click "New Configuration" to create your first one'}
              </div>
            ) : (
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        {config.id === activeConfigId && (
                          <span className="px-2 py-1 text-xs bg-blue-100 text-blue-700 rounded">Currently Active</span>
                        )}
